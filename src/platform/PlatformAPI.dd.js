...
class PlatformAPI {
    ...
    static getStorage(name, async, callback) {
        if (async) {
            ...
            var res = currentPlatform.getStorageSync({ key: name });
    ...
    static request(options) {
        return currentPlatform.httpRequest({
            url: options.url,
            data: options.data,
