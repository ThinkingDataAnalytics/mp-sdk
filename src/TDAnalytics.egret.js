import ThinkingDataAPIForNative from './ThinkingDataAPI.egret';
...
class TDAnalytics {
    ...
    /**
     * Gets the public event properties that have been set.
     * @param {Function} callback asynchronous return public event properties
     * @param {String} appId Project App ID
     */
    static getSuperPropertiesAsync(callback, appId) {
        this._shareInstance(appId).getSuperProperties(callback);
    }
    ...
    /**
     * Gets prefabricated properties for all events.
     * @param {Function} callback asynchronous return prefabricated properties
     * @param {String} appId Project App ID
     */
    static getPresetPropertiesAsync(callback, appId) {
        this._shareInstance(appId).getPresetProperties(callback);
    }
    ...
    /**
     * Get a account ID The #account_id value in the reported data.
     * @param {Function} callback asynchronous return account ID
     * @param {String} appId Project App ID
     */
    static getAccountIdAsync(callback, appId) {
        this._shareInstance(appId).getAccountId(callback);
    }
    ...
    /**
     * Get a visitor ID The #distinct_id value in the reported data.
     * @param {Function} callback asynchronous return distinct ID
     * @param {String} appId Project App ID
     */
    static getDistinctIdAsync(callback, appId) {
        this._shareInstance(appId).getDistinctId(callback);
    }
    ...
    /**
     * Get device ID
     * @param {Function} callback asynchronous return Device ID
     * @param {String} appId Project App ID
     */
    static getDeviceIdAsync(callback, appId) {
        this._shareInstance(appId).getDeviceId(callback);
    }
