...
let buttonData = ["TRACK", "TRACK UPDATE", "TRACK OVERWRITE", "TRACK FIRTSTEVENT", "LOGIN", "LOGOUT", "SET USER_PROPERTIES", "SET AUTHORIZEOPENID", "SET DYNAMIC_SUPER_PROPERTIES", "GET DEVICE ID"];
let layoutData = [];
